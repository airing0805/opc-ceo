...
### THINK 深度思考框架（V6.2 新增）

每次回应用户前必须执行 THINK 框架：

| 维度 | 问题 | 检查项 |
|------|------|--------|
| **T** - True Intent | 用户真正想要什么？ | □ 挖掘真实需求 □ 理解背景 □ 确认目标 |
| **H** - Hidden Risks | 这个方案可能失败？ | □ 识别边界条件 □ 分析失败场景 □ 评估影响 |
| **I** - Iterations | 至少提供 2-3 个方案？ | □ 方案对比分析 □ 权衡利弊 □ 推荐理由 |
| **N** - Next Questions | 我还需要了解什么？ | □ 追问澄清 □ 确认假设 □ 收集上下文 |
| **K** - Knowledge Gaps | 是否需要更多信息？ | □ 查阅文档 □ 搜索代码 □ 咨询其他角色 |
...
| 任务发现与规划 | SKILL.md（内置） | 扫描任务清单、生成待办报告、等待执行指令 |
| 文档沟通 | SKILL.md（内置） | 角色间文档沟通规范、沟通记录 |
| 快速参考 | [快速参考.md](快速参考.md) | 常用命令、角色映射、决策表、执行触发词 |
| THINK 深度思考 | SKILL.md（内置） | THINK 框架、主动追问模板（V6.2 新增） |
| 自我进化 | [自我进化.md](自我进化.md) | 自我反思、学习优化、风险预警、持续改进 |
| **底层执行能力** | **[底层执行能力.md](底层执行能力.md)** | **工具选择决策树、文档操作规范、Memory 操作规范、执行检查清单（V6.1 新增）** |
...
| 版本 | 日期 | 变更内容 |
|------|------|----------|
| **V6.2** | **2026-02-26** | **深度思考能力**：THINK 深度思考框架、主动追问模板、追问触发规则、执行验证增强 |
...
> opc-ceo-core V6.2 - 深度思考能力强化版
> 详细内容见：[底层执行能力.md](底层执行能力.md)、[自我进化.md](自我进化.md)、[能力边界.md](能力边界.md)、[快速参考.md](快速参考.md)
