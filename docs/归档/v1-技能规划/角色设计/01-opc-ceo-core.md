...
3. **文档创建**
   - 创建角色设计文档 `docs/版本规划/v1-技能规划/角色设计/NN-角色名.md`
   - 遵循文档模板规范
...
**CEO 直接具备教练能力**，无需独立教练角色。

当 CEO 自身无法承担教练工作时（如评估客观性不足、时间压力过大等），可考虑招聘专项教练。
...
| 评估维度 | 合格 | 优秀 | 卓越 |
|----------|------|------|------|
| 角色理解 | 知道核心职责 | 理解边界和限制 | 预判冲突和优化 |
| 任务分配 | 80%正确 | 90%正确 | 95%+正确 |
| 验收质量 | 基本检查 | 全面检查 | 预防性检查 |
| 成长识别 | 发现明显问题 | 发现隐蔽问题 | 预防性问题 |
